...
function EmployeeDashboard() {
  ...
  const dashboardStats = [
    ...
    ['bi-calendar2-check-fill', 'Pending Leaves', pendingLeaves.length, 'Awaiting admin review'],
    ['bi-patch-check-fill', 'Approved Leaves', approvedLeaves.length, 'Approved by admin'],
  ...
  return (
    <main className="employee-shell employee-dashboard-shell">
      <aside className="employee-sidebar">
        <Link className="employee-brand" to="/">
